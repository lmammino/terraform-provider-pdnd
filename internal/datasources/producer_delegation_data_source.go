...
var _ datasource.DataSource = &producerDelegationDataSource{}

type producerDelegationDataSource struct {
	client api.DelegationsAPI
}

func NewProducerDelegationDataSource() datasource.DataSource {
	return &producerDelegationDataSource{}
}

func (d *producerDelegationDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_producer_delegation"
}

func (d *producerDelegationDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Fetches a single PDND producer delegation by ID.",
...
func (d *producerDelegationDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *producerDelegationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	delegation, err := d.client.GetDelegation(ctx, "producer", id)
	if err != nil {
		resp.Diagnostics.AddError("Error reading producer delegation", err.Error())
		return
	}
